...
export default function EmailGate({
  ...
  <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl" style={{ backgroundColor: colorWithAlpha(pageBackground, 0.72), borderBottom: `1px solid ${colorWithAlpha(borderColor, 0.5)}` }}>
    <div className="mx-auto max-w-6xl px-6 md:px-8">
      <div className="flex h-16 items-center justify-between">
        <div className="flex items-center gap-3">
          <BrandMark size={30} />
          <span style={{ fontFamily: headingFontStack, color: textPrimary, letterSpacing: '-0.01em', fontWeight: 500 }} className="text-lg">{brandName}</span>
        </div>
        <button onClick={openLogin} className="rounded-full px-5 py-2 text-sm transition-opacity hover:opacity-80" style={{ color: textPrimary, border: `1px solid ${colorWithAlpha(borderColor, 0.8)}`, fontWeight: 500 }}>
          Get started
        </button>
      </div>
    </div>
  ...
  <section id="hero" className="relative flex min-h-screen items-center justify-center overflow-hidden" style={{ minHeight: '100svh' }}>
    ...
    {heroHasVideo ? (
      ...
      <div className="absolute inset-0 h-full w-full" style={{ background: heroGradient }} />
    )}
    <div className="absolute inset-0" style={{ backgroundColor: 'rgba(2,6,23,0.1)' }} />
    <div className="absolute inset-0" style={{ background: 'linear-gradient(to bottom, rgba(2,6,23,0.35), rgba(2,6,23,0.1) 40%, rgba(2,6,23,0.45))' }} />

    <div className="relative z-10 mx-auto max-w-4xl px-6 pt-24 pb-16 text-center md:px-8">
      <p className="mb-8 text-sm uppercase tracking-[0.4em]" style={{ color: '#ffffff' }}>{tagline}</p>
      <h1 className="mx-auto max-w-3xl text-5xl leading-[1.05] md:text-7xl" style={{ fontFamily: headingFontStack, color: '#ffffff', fontWeight: 300, letterSpacing: '-0.03em' }}>
        Get outfits from your existing wardrobe.
      </h1>
      <p className="mx-auto mt-8 max-w-xl text-lg leading-relaxed md:text-xl" style={{ color: '#ffffff', fontWeight: 300 }}>
        Organize your wardrobe with AI so getting dressed feels effortless.
      </p>
      <div className="mt-12 flex items-center justify-center">
        <button data-testid="button-open-login" onClick={openLogin} className="group inline-flex items-center gap-2 rounded-full px-8 py-4 text-base transition-transform hover:scale-[1.02]" style={{ backgroundColor: primaryColor, color: onPrimary, fontWeight: 500, boxShadow: '0 10px 40px -12px rgba(0,0,0,0.5)' }}>
          Get started
  ...
  <section className="relative py-28 md:py-40" style={{ backgroundColor: pageBackground }}>
    <div className="mx-auto max-w-3xl px-6 text-center md:px-8">
      <div className="mx-auto mb-10 flex h-12 w-12 items-center justify-center rounded-full" style={{ backgroundColor: colorWithAlpha(primaryColor, 0.08) }}>
        <Eye size={22} style={{ color: primaryColor }} />
      </div>
      <p className="text-3xl leading-[1.3] md:text-5xl" style={{ fontFamily: headingFontStack, color: textPrimary, fontWeight: 300, letterSpacing: '-0.02em' }}>
        A closet full of clothes,
        <span style={{ color: textMuted }}> and still the feeling that you have absolutely nothing to wear.</span>
      </p>
    </div>
  </section>

  <section className="relative py-24 md:py-36" style={{ backgroundColor: sectionBackground }}>
    <div className="mx-auto max-w-5xl px-6 md:px-8">
      <div className="mb-16 text-center">
        <p className="mb-4 text-sm uppercase tracking-[0.3em]" style={{ color: textSubtle }}>The point of view</p>
        <h2 className="mx-auto max-w-2xl text-4xl leading-tight md:text-5xl" style={{ fontFamily: headingFontStack, color: textPrimary, fontWeight: 300, letterSpacing: '-0.02em' }}>
          Mura does the thinking for you.
        </h2>
      </div>
      <div className="grid gap-8 md:grid-cols-3">
        {[
          { icon: <Layers size={22} style={{ color: primaryColor }} />, title: 'Your real clothes', body: 'It works with the wardrobe you already own — no shopping, no new pieces required.' },
          { icon: <Sparkles size={22} style={{ color: primaryColor }} />, title: 'No fashion sense needed', body: 'Most wardrobe apps assume you already know how to style yourself. Mura does not.' },
          { icon: <Compass size={22} style={{ color: primaryColor }} />, title: 'Suited to real occasions', body: 'Your clothes paired into outfits for real moments, no expertise on your part.' },
        ].map((c, i) => (
          <div key={i} className="rounded-2xl p-8" style={{ backgroundColor: panelColor, border: `1px solid ${colorWithAlpha(borderColor, 0.6)}`, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
            <div className="mb-6 flex h-11 w-11 items-center justify-center rounded-full" style={{ backgroundColor: colorWithAlpha(primaryColor, 0.08) }}>
              {c.icon}
            </div>
            <h3 className="mb-3 text-lg" style={{ fontFamily: headingFontStack, color: textPrimary, fontWeight: 500 }}>{c.title}</h3>
            <p className="text-sm leading-relaxed" style={{ color: textMuted, fontWeight: 300 }}>{c.body}</p>
          </div>
        ))}
      </div>
    </div>
  ...
  <section className="relative py-28 md:py-40" style={{ backgroundColor: pageBackground }}>
    <div className="mx-auto max-w-4xl px-6 md:px-8">
      <div className="grid items-center gap-12 md:grid-cols-2">
        <div>
          <p className="mb-4 text-sm uppercase tracking-[0.3em]" style={{ color: textSubtle }}>Why it exists</p>
          <h2 className="text-3xl leading-tight md:text-4xl" style={{ fontFamily: headingFontStack, color: textPrimary, fontWeight: 300, letterSpacing: '-0.02em' }}>
            Built by the person who needed it.
          </h2>
        </div>
        <div>
          <p className="text-lg leading-relaxed" style={{ color: textMuted, fontWeight: 300 }}>
            The founder is the customer — someone who repeats clothes, sometimes feels like they have nothing to wear, and is not particularly interested in styling. Not a fashion obsessive. An everyday person who owns plenty of clothes but does not engage with them effectively.
          </p>
          <p className="mt-6 text-lg leading-relaxed" style={{ color: textPrimary, fontWeight: 400 }}>
            Built out of lived frustration, not aesthetic passion.
          </p>
        </div>
      </div>
    </div>
  ...
  <section className="relative py-24 md:py-36" style={{ backgroundColor: sectionBackground }}>
    <div className="mx-auto max-w-3xl px-6 text-center md:px-8">
      <p className="mb-4 text-sm uppercase tracking-[0.3em]" style={{ color: textSubtle }}>First version</p>
      <h2 className="mx-auto max-w-xl text-4xl leading-tight md:text-5xl" style={{ fontFamily: headingFontStack, color: textPrimary, fontWeight: 300, letterSpacing: '-0.02em' }}>
        Start by organizing your wardrobe.
      </h2>
      <div className="mx-auto mt-10 flex max-w-md flex-col gap-3">
        {['Everything you own, in one place', 'Effortless to get dressed', 'No styling knowledge required'].map((t, i) => (
          <div key={i} className="flex items-center gap-3 rounded-full px-6 py-3 text-left" style={{ backgroundColor: panelColor, border: `1px solid ${colorWithAlpha(borderColor, 0.6)}` }}>
            <Check size={16} style={{ color: primaryColor }} />
            <span className="text-sm" style={{ color: textPrimary, fontWeight: 400 }}>{t}</span>
          </div>
        ))}
      </div>
    </div>
  ...
  <section className="relative py-32 md:py-44" style={{ background: brandGradient }}>
    <div className="mx-auto max-w-2xl px-6 text-center md:px-8">
      <BrandMark size={44} />
      <h2 className="mx-auto mt-8 max-w-xl text-4xl leading-tight md:text-5xl" style={{ fontFamily: headingFontStack, color: onPrimary, fontWeight: 300, letterSpacing: '-0.02em' }}>
        Getting dressed, made effortless.
      </h2>
      <div className="mt-10 flex items-center justify-center">
        <button onClick={openLogin} className="group inline-flex items-center gap-2 rounded-full px-8 py-4 text-base transition-transform hover:scale-[1.02]" style={{ backgroundColor: onPrimary, color: primaryColor, fontWeight: 500 }}>
          Get started
          <ArrowRight size={18} className="transition-transform group-hover:translate-x-1" />
        </button>
      </div>
  ...
  <footer className="py-12" style={{ backgroundColor: pageBackground, borderTop: `1px solid ${colorWithAlpha(borderColor, 0.5)}` }}>
    <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 md:flex-row md:px-8">
      <div className="flex items-center gap-3">
        <BrandMark size={24} />
        <span style={{ fontFamily: headingFontStack, color: textPrimary, fontWeight: 500 }}>{brandName}</span>
      </div>
      <p className="text-sm" style={{ color: textSubtle, fontWeight: 300 }}>Organize your wardrobe with AI.</p>
    </div>
  </footer>
</div>
